...
algorithm=choice(g,'控制策略',1,{'purerl纯奖励RL(3.2主角,免标定)','sweepcal全速域标定+精化(对照,需150步)',...
    'rl仿真器预训练+微调(对照,需150步)','openloop开环固定基线','esc连续ESC','qnewton牛顿拟合寻优',...
    'windinfer已知曲线oracle参照','est已知曲线EKF(参照)','known已知风+曲线oracle上限'},...
    {'purerl','sweepcal','rl','openloop','esc','qnewton','windinfer','est','known'},'purerl');
...
prepare();
    ...
    function redraw()
        ...
        setSlice(h.ptProbe,sp,pm,tags,'pure');
