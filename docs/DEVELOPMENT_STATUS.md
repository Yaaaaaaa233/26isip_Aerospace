...
更新时间：2026-09-08（第十次更新：**T2 正式验收 27/27 机器门 PASS**——第四次正式跑（[证据](evidence/T2_CLOSEDLOOP_20260908/README.md)，图集 7 张+指标表+四跑全史），nominal |Percent| 中位数 0.72%、E 组标准饱和负向四门全过、A3/A4 按 §9.4 重预登记门槛过；余 B2/D5 两项人工核对待叶安。跑批过程揪出并修复三个实质缺陷（法向风泄漏进功率→切向化+G-B1n 门、废阻前馈圆周切向错误、E_pred Picard 未收敛 2.2%→收敛驱动 PREREG v1.1）。第九次更新：H3 修复 U 形恢复；第八次：全项目重验收扫描；第七次：P2 WP1–WP4；第六次：P2 前置交付；第五次：M3 §7.3 正式批次 PASS @d552a14 待独立复验）
