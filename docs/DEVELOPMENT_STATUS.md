...
更新时间：2026-09-08（第十四次更新：**T2.4 eta 特性展示正式批 E1–E6 全 PASS**——eta 路径模型 v1.1（δ(v)=δ₀·(vi/vi₀)^κ、映射 0.55、回中项删除）落地，谷底 η\*(v) 成为模型输出：悬停 **0.899**（文献锚 ~0.90）→ 8 m/s **0.950** 单调回漂（12/12 段）；悬停 P(η=1)=487.3 W 与 T2 冻结口径逐位一致、链检查 24/24 门无回归；证据见 [T24_ETA_CHAR](evidence/T24_ETA_CHAR_20260908/README.md)，人工验收包 H1–H9 在仓库外 `第二阶段\T24人工验收包_20260908\`。第十三次更新：T2.4 重定义 + eta 寻优平台冻结（叶安三决策，[T24_ETA_CHAR_PLAN](T24_ETA_CHAR_PLAN.md) v1.0 + 06 v1.3 + T2 清单 v1.3）；此前：M3 放行（Codex 第四轮 C1–C7 全 PASS）/T2 关闭/T2 27×27/H3 修复/全项目重验收/P2 落地与前置交付/M3 §7.3）
